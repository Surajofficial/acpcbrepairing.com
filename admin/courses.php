...
<body class="">
    <div class="page">
        <div class="page-main">
            ...
            include './common/check_courses.php'; ?>
                ...
                <div class="container">
                    <div class="page-header">
                        ...
                        <div class="page-options d-flex">
                            <a href="add_courses.php" id="add" class="btn btn-green btn-sm">Add Courses</a>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function load(cat_id = cat, state_id = state, courses_id = id) {
                page_number = page_number + 1
                if (count_blog != 0 && count_blog != total) {
                    $.ajax({
                        url: './common/courses_load.php',
                        type: 'POST',
                        data: {
                            cat_id: cat_id,
                            state_id: state_id,
            ...
            $(document).on('click', '.delete', function(e) {
                ...
                var conf = confirm('Do You Want to delet this courses');
                if (conf) {
                    $.ajax({
                        type: "POST",
                        url: './common/deletecourses.php',
                        data: {
                            url: url,
                            youtube: youtube,
                            banner: banner
